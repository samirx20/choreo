...
export const FloatingDesignToolbar: React.FC<FloatingDesignToolbarProps> = ({
  ...
  return (
    <div
      className="absolute bottom-6 left-1/2 -translate-x-1/2 z-40 flex items-center gap-1 bg-card/90 backdrop-blur-md border border-border shadow-2xl px-2 py-1.5 rounded-full select-none text-foreground transition-all animate-in fade-in zoom-in-95 duration-150"
    ...
    >
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent
          ...
          sideOffset={10}
          align="center"
          className="w-44 bg-popover/95 border-border text-popover-foreground p-1.5 shadow-2xl rounded-xl"
        >
          <DropdownMenuItem
            onClick={() => handleSelectShape("rectangle")}
            className="gap-2.5 cursor-pointer hover:bg-muted text-xs py-2 px-2.5 rounded-lg"
          >
      ...
      <DropdownMenu>
        ...
        >
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground font-mono">Shift+P</span>
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button
            type="button"
            className="h-8 px-2 rounded-full flex items-center gap-1 text-muted-foreground hover:text-foreground hover:bg-muted transition-colors"
        ...
        <DropdownMenuContent
          ...
          sideOffset={10}
          align="center"
          className="w-48 bg-popover/95 border-border text-popover-foreground p-1.5 shadow-2xl rounded-xl"
        >
          <DropdownMenuItem
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground font-mono">PNG, JPG</span>
          </DropdownMenuItem>
          ...
          >
            ...
            <span className="text-[10px] text-muted-foreground font-mono">.svg</span>
          </DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
